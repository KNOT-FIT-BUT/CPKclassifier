# -*- coding: UTF-8 -*-
"""
Obsahuje třídu pro uložení a načtení dat pro DocClassifier.
...
class DocClassifierDataDumpInvalidFile(Exception):
    """
...
class DocClassifierDataDump(object):
    """
    ...
    def load(self, filename):
        """
        Načtení DocClassifierDataDump ze souboru.
        
        :param filename: Cesta k souboru ze kterého bude objekt načten.
        :raises: DocClassifierDataDumpInvalidFile při nevalidním souboru.
        """
    ...
    def loadBasicData(self, filename):
        ...
        if os.path.isfile(filename):
            ...
            try:
                ...
                raise DocClassifierDataDumpInvalidFile()
    ...
    def loadFrom(cls, filename):
        """
        Načte DocClassifierDataDump ze souboru. (Vytvoří nový objekt)
        
        :param filename: Cesta k souboru ze kterého bude objekt načten.
        :returns:  DocClassifierDataDump -- načtený ze souboru
        :raises: DocClassifierDataDumpInvalidFile při nevalidním souboru.
        """
        logging.info("začátek načítání dat")
        return DocClassifierDataDump().load(filename)
        logging.info("konec načítání dat")
